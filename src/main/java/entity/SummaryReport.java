...
public class SummaryReport {
    ...
    private final List<Column> columns_used;
    private final DataRow data_rows_used;

    public SummaryReport(int summary_id, String report_name, List<Column> columns_used, DataRow data_rows_used, DataSet dataset) {

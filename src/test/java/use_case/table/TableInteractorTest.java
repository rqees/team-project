...
//following are the test code if using mockito
//import entity.Column;
//import entity.DataRow;
//import entity.DataSet;
//import org.junit.jupiter.api.BeforeEach;
...
///**
// * Test class for DisplayTableInteractor.
// * Achieves 100% code coverage for the Display Table use case.
// */
//class DisplayTableInteractorTest {
//    private CurrentTableGateway mockGateway;
//    private DisplayTableOutputBoundary mockPresenter;
//    private DisplayTableInteractor interactor;
//
//    @BeforeEach
//    void setUp() {
//        mockGateway = mock(CurrentTableGateway.class);
//        mockPresenter = mock(DisplayTableOutputBoundary.class);
//        interactor = new DisplayTableInteractor(mockGateway, mockPresenter);
//    }
//
//    @Test
//    void testExecute_NullDataSet_CallsFailureView() {
//        // Arrange
//        when(mockGateway.load()).thenReturn(null);
//
//        // Act
//        interactor.execute();
//
//        // Assert
//        verify(mockPresenter).prepareFailureView("No dataset to display");
...
//        when(dataSet.getColumns()).thenReturn(new ArrayList<>());
//        when(dataSet.getRows()).thenReturn(createMockRows(1));
//        when(mockGateway.load()).thenReturn(dataSet);
//
//        // Act
//        interactor.execute();
//
//        // Assert
//        verify(mockPresenter).prepareFailureView("Dataset is empty");
//        verify(mockPresenter, never()).prepareSuccessView(any());
//    }
//
//    @Test
...
//        // Arrange
//        DataSet dataSet = mock(DataSet.class);
//        when(dataSet.getColumns()).thenReturn(createMockColumns(Arrays.asList("Col1", "Col2")));
//        when(dataSet.getRows()).thenReturn(new ArrayList<>());
//        when(mockGateway.load()).thenReturn(dataSet);
//
//        // Act
//        interactor.execute();
...
//        // Arrange
//        List<String> headers = Arrays.asList("Name", "Age", "City");
//        List<Column> columns = createMockColumns(headers);
//
//        List<DataRow> rows = new ArrayList<>();
//        rows.add(createMockRow(Arrays.asList("Alice", "25", "Toronto")));
//        rows.add(createMockRow(Arrays.asList("Bob", "30", "Vancouver")));
//        rows.add(createMockRow(Arrays.asList("Charlie", "35", "Montreal")));
//
//        DataSet dataSet = mock(DataSet.class);
//        when(dataSet.getColumns()).thenReturn(columns);
//        when(dataSet.getRows()).thenReturn(rows);
//        when(mockGateway.load()).thenReturn(dataSet);
//
//        // Act
//        interactor.execute();
//
//        // Assert
//        ArgumentCaptor<DisplayTableOutputData> captor =
//                ArgumentCaptor.forClass(DisplayTableOutputData.class);
//        verify(mockPresenter).prepareSuccessView(captor.capture());
//
//        DisplayTableOutputData outputData = captor.getValue();
//
//        // Verify headers
//        assertArrayEquals(new String[]{"Name", "Age", "City"}, outputData.getHeaders());
//
//        // Verify row data
//        String[][] rowData = outputData.getRowData();
//        assertEquals(3, rowData.length);
//        assertArrayEquals(new String[]{"Alice", "25", "Toronto"}, rowData[0]);
//        assertArrayEquals(new String[]{"Bob", "30", "Vancouver"}, rowData[1]);
//        assertArrayEquals(new String[]{"Charlie", "35", "Montreal"}, rowData[2]);
...
//
//        List<DataRow> rows = new ArrayList<>();
//        rows.add(createMockRow(Arrays.asList("1", "Test")));
//
//        DataSet dataSet = mock(DataSet.class);
//        when(dataSet.getColumns()).thenReturn(columns);
//        when(dataSet.getRows()).thenReturn(rows);
...
//
//        DisplayTableOutputData outputData = captor.getValue();
//        assertEquals(1, outputData.getRowData().length);
//        assertArrayEquals(new String[]{"1", "Test"}, outputData.getRowData()[0]);
//    }
//
//    @Test
//    void testExecute_SingleColumnDataSet() {
...
//
//        List<DataRow> rows = new ArrayList<>();
//        rows.add(createMockRow(Arrays.asList("Value1")));
//        rows.add(createMockRow(Arrays.asList("Value2")));
//
//        DataSet dataSet = mock(DataSet.class);
//        when(dataSet.getColumns()).thenReturn(columns);
//        when(dataSet.getRows()).thenReturn(rows);
...
//
//        DisplayTableOutputData outputData = captor.getValue();
//        assertArrayEquals(new String[]{"SingleColumn"}, outputData.getHeaders());
//        assertEquals(2, outputData.getRowData().length);
//    }
//
//    @Test
//    void testExecute_LargeDataSet() {
...
//        List<DataRow> rows = new ArrayList<>();
//        for (int i = 0; i < 100; i++) {
//            rows.add(createMockRow(Arrays.asList(
//                    "A" + i, "B" + i, "C" + i, "D" + i, "E" + i
//            )));
//        }
//
...
//
//        DisplayTableOutputData outputData = captor.getValue();
//        assertEquals(5, outputData.getHeaders().length);
//        assertEquals(100, outputData.getRowData().length);
//    }
//
//    @Test
//    void testExecute_DataSetWithEmptyStrings() {
...
//
//        List<DataRow> rows = new ArrayList<>();
//        rows.add(createMockRow(Arrays.asList("", "Value")));
//        rows.add(createMockRow(Arrays.asList("Value", "")));
//
//        DataSet dataSet = mock(DataSet.class);
//        when(dataSet.getColumns()).thenReturn(columns);
...
//
//        DisplayTableOutputData outputData = captor.getValue();
//        assertEquals("", outputData.getRowData()[0][0]);
//        assertEquals("Value", outputData.getRowData()[0][1]);
//        assertEquals("Value", outputData.getRowData()[1][0]);
//        assertEquals("", outputData.getRowData()[1][1]);
//    }
//
//    @Test
//    void testExecute_DataSetWithSpecialCharacters() {
...
//
//        List<DataRow> rows = new ArrayList<>();
//        rows.add(createMockRow(Arrays.asList("Test@123", "Hello, World!")));
//        rows.add(createMockRow(Arrays.asList("User#456", "Line1\nLine2")));
//
//        DataSet dataSet = mock(DataSet.class);
//        when(dataSet.getColumns()).thenReturn(columns);
//        when(dataSet.getRows()).thenReturn(rows);
...
//
//        DisplayTableOutputData outputData = captor.getValue();
//        assertEquals("Test@123", outputData.getRowData()[0][0]);
//        assertEquals("Hello, World!", outputData.getRowData()[0][1]);
//        assertEquals("User#456", outputData.getRowData()[1][0]);
//        assertEquals("Line1\nLine2", outputData.getRowData()[1][1]);
//    }
//
//    @Test
//    void testExecute_VerifiesCorrectArrayConversion() {
...
//
//        List<DataRow> rows = new ArrayList<>();
//        rows.add(createMockRow(Arrays.asList("1", "2", "3")));
//
//        DataSet dataSet = mock(DataSet.class);
//        when(dataSet.getColumns()).thenReturn(columns);
//        when(dataSet.getRows()).thenReturn(rows);
...
//        DisplayTableOutputData outputData = captor.getValue();
//
//        // Verify that headers array is correctly sized
//        assertEquals(headers.size(), outputData.getHeaders().length);
//
//        // Verify that row data 2D array is correctly sized
//        assertEquals(1, outputData.getRowData().length);
//        assertEquals(3, outputData.getRowData()[0].length);
//    }
//
//    // Helper methods
//    private List<Column> createMockColumns(List<String> headers) {
//        List<Column> columns = new ArrayList<>();
//        for (String header : headers) {
//            Column column = mock(Column.class);
//            when(column.getHeader()).thenReturn(header);
//            columns.add(column);
//        }
//        return columns;
//    }
//
//    private DataRow createMockRow(List<String> cells) {
//        DataRow row = mock(DataRow.class);
//        when(row.getCells()).thenReturn(cells);
//        return row;
//    }
//
//    private List<DataRow> createMockRows(int count) {
//        List<DataRow> rows = new ArrayList<>();
//        for (int i = 0; i < count; i++) {
//            rows.add(mock(DataRow.class));
//        }
//        return rows;
//    }
//}